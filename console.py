...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """Boots main behavior to redo previous cmd"""
        pass

    def do_create(self, line):
        """Generate examples designated by user"""
        if len(line) == 0:
    ...
    def do_show(self, line):
        """Pull string portraying: name and id"""
        if len(line) == 0:
            print("** class name missing **")
            return
        args = parse(line)
    ...
    def do_destroy(self, line):
        """Dismantle instance designated by user; Save changes to JSON file"""
        if len(line) == 0:
            print("** class name missing **")
            return
        args = parse(line)
    ...
    def do_all(self, line):
        """Pull all objects or all objects of designated class"""
        args = parse(line)
        obj_list = []
        if len(line) == 0:
    ...
    def do_count(self, line):
        """Show count of instances designated"""
    ...
    def default(self, line):
        """Allows class name followed by arguement"""
        args = line.split('.')
        class_arg = args[0]
        if len(args) == 1:
